...
class EmploymentReferenceEmail extends Mailable
{
    ...
    {
        return $this->subject($this->agencyData['name'] . ' - Urgent Employment Reference for ' . $this->applicantInformation['app_name'] . ' ' . $this->applicantInformation['l_name'])->view('Mail.employment_ref_email');
    }
}
