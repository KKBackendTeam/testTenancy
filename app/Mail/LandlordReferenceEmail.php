...
class LandlordReferenceEmail extends Mailable
{
    ...
    {
        return $this->subject($this->agencyData['name'] . ' - Urgent Landlord Reference for ' . $this->applicantInformation['app_name'] . ' ' . $this->applicantInformation['l_name'])->view('Mail.landlord_ref_email');
    }
}
