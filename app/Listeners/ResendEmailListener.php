...
class ResendEmailListener
{
     ...
     * @return void
     */
    public function handle(ResendEmailEvent $event)
    {
        $tenancy_event = new TenancyEvents();
        $tenancy_event->agency_id = JWTAuth::parseToken()->authenticate()->agency_id;
        $tenancy_event->tenancy_id = $event->information['tenancy_id'];
        ...
        $items[] = 'Resend Email' . $event->information['email'] . ' to the tenancy.';
