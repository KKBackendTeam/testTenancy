                ...
                <ul>
                    ...
                    <li>
                        <div class="image_resize" style="    max-width:140px;width: 100%;height: 65px;">
                              ...
                              <img 
                              src="{{ config('global.backSiteUrl')}}/fetch_applicant/storage/applicant/agreement_signature/{{$applicant['agreement_signature'] }}?token={{\JWTAuth::getToken()}}"
  ...
  @if(!empty($tenancy['reviewer']) && $tenancy->review_agreement == 1)
        ...
        <div class="table-layouts">
                <ul>
                    ...
                    <li>
                        <div class="image_resize" style="max-width: 140px;width: 100%;height: 65px;">
                              <img src="{{ config('global.backSiteUrl')}}/fetch_applicant/storage/applicant/agreement_signature/{{ $tenancy['reviewer']['agreement_signature'] }}?token={{\JWTAuth::getToken()}}"
                         style="width:100%; height:80px;">
                            </div>
                              <br>
                              <p class="dt">
